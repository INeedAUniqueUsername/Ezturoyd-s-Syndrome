...
public class Projectile_Tracking extends Projectile {
	...
	public void updateTracking() {
		/*
		 * if(target == null) { return; } else if(!target.getActive()) { target
		 * = null; return; }
		 */
		...
		double turnLeftDistance = SpaceHelper.getDistanceBetweenPos(SpaceHelper.polarOffset(pos, velAngle - 90, 1),
				pos_target);
		double turnRightDistance = SpaceHelper.getDistanceBetweenPos(SpaceHelper.polarOffset(pos, velAngle + 90, 1),
				pos_target);
